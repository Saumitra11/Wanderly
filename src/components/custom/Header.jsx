  ...
  return (
    <div className='p-4 shadow-lg bg-white/70 backdrop-blur-md flex justify-between items-center'>
      ...
      <div className='flex items-center gap-4'>
        <Button className="px-5 py-2 rounded-md text-white bg-gradient-to-r from-blue-500 to-purple-600 hover:scale-105 transition-all duration-200 cursor-pointer">Sign In</Button>
